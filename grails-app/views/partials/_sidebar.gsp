...
<div class="list-group">
    <g:link
        ...
        action="index"
        method="GET"
        class="list-group-item ${controllerName == 'dashboard' ? 'active' : ''}">Tablero</g:link>
    ...
    <sec:ifAnyGranted roles='ROLE_PROTOCOL, ROLE_ASSISTANT, ROLE_ACADEMIC_COORDINATOR, ROLE_ADMINISTRATIVE_COORDINATOR, ROLE_HEAD_OFFICE_DELEGATE, ROLE_ACADEMIC_DIRECTOR, ROLE_ADMINISTRATIVE_DIRECTOR'>
        ...
        <g:link
            resource="employee"
            action="guests"
            params="[employeeId: springSecurityService.currentUser.employee.id]"
            method="GET"
            class="list-group-item ${controllerName == 'employee' ? 'active' : ''}">Lista de visitas</g:link>
    </sec:ifAnyGranted>
    ...
    <g:link
        ...
        action="index"
        method="GET"
        class="list-group-item ${controllerName == 'ticket' && !(actionName in ['tickets', 'filterByStatus', 'filterByEmployee', 'filterByDevice', 'filter', 'applyFilter']) ? 'active' : ''}">Soporte</g:link>
</div>
...
<sec:ifAllGranted roles='ROLE_ADMIN'>
    <div class="list-group">
        <g:link
            ...
            action="index"
            method="GET"
            class="list-group-item ${controllerName == 'classroom' ? 'active' : ''}">Aulas</g:link>

        <g:link
            resource="datashow"
            action="index"
            method="GET"
            class="list-group-item ${controllerName == 'datashow' ? 'active' : ''}" method="GET">Cañones</g:link>

        <g:link
            resource="career"
            action="index"
            method="GET"
            class="list-group-item ${controllerName == 'career' ? 'active' : ''}">Carreras</g:link>

        <g:link
            controller="coordination"
            action="index"
            method="GET"
            class="list-group-item ${controllerName == 'coordination' ? 'active' : ''}">Coordinaciones</g:link>

        <g:link
            resource="employee"
            action="index"
            method="GET"
            class="list-group-item ${controllerName in ['employee', 'employeeCoordination', 'user'] && !(actionName in ['profile', 'password', 'changePassword']) ? 'active' : ''}">Empleados</g:link>

        <g:link
            resource="holiday"
            action="index"
            method="GET"
            class="list-group-item ${controllerName == 'holiday' ? 'active' : ''}">Dias feriados</g:link>

        <g:link
            controller="device"
            action="index"
            method="GET"
            class="list-group-item ${controllerName == 'device' ? 'active' : ''}">Recursos</g:link>

        <g:link
            resource="role"
            action="index"
            method="GET"
            class="list-group-item ${controllerName == 'role' ? 'active' : ''}">Roles</g:link>
    </div>
</sec:ifAllGranted>
